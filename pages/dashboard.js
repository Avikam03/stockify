      ...
      <Navbar />
        ...
        <main className={styles.main}>
          ...
          <div className="flex justify-center mt-5">
              <button className="bg-neutral-900 hover:bg-black-700 text-white font-bold py-2 px-4 rounded content-center mx-5"	onClick={qmsdisplay}>
                  Quantitative Momentum Strategy
              </button>
              <button className="bg-neutral-900 hover:bg-black-700 text-white font-bold py-2 px-4 rounded content-center mx-5" onClick={qvsdisplay}>
...
{/* {
            ...
            {/* {Object.keys(qms).length === 0 == {} ? <h1>Data is not here</h1> :
